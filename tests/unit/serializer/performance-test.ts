...
describe('Serializer - Performance Tests', () => {
    ...
    for (let i = 0; i < count; i++) {
      statements.push(
        st(
          sym(`http://example.com/subject${i}`),
          sym(`http://example.com/predicate${i}`),
          lit(`Value ${i} with some text content that makes it longer`)
        )
      )
    }
    return { kb, statements }
  ...
  function generateStatementsWithBlankNodes(count: number) {
    ...
    for (let i = 0; i < count; i++) {
      ...
      statements.push(st(sym(`http://example.com/subject${i}`), sym(`http://example.com/predicate${i}`), bnode))
    }
    return { kb, statements }
  }
  ...
  describe('statementsToN3 performance', () => {
    ...
    it('should handle large literals efficiently', () => {
      ...
      console.log(`  ✓ N3 - 1,000 statements with large literals: ${duration.toFixed(2)}ms`)
    })

    it('should handle prefixes efficiently', () => {
      const { kb, namespaces, statements } = generateStatementsWithPrefixes(1000)
      const serializer = new N3Serializer(kb)
      ...
      console.log(`  ✓ N3 - 1,000 statements with prefixes: ${duration.toFixed(2)}ms`)
    })
    ...
    it('should handle blank nodes efficiently', () => {
      ...
      expect(result).to.be.a('string')
      expect(duration).to.be.below(1000)
      console.log(`  ✓ N3 - 1,000 statements with blank nodes: ${duration.toFixed(2)}ms`)
    })
    ...
    it('should handle rdf:type efficiently', () => {
      ...
      expect(result).to.be.a('string')
      expect(duration).to.be.below(1000)
      console.log(`  ✓ N3 - 1,000 statements with types: ${duration.toFixed(2)}ms`)
    })
    ...
    it('should handle many prefixes efficiently', () => {
      ...
      console.log(`  ✓ N3 - 1,000 statements with 100 prefixes: ${duration.toFixed(2)}ms`)
    })
  })
  ...
  describe('statementsToNTriples performance', () => {
    it('should serialize 100 statements quickly', () => {
      ...
      console.log(`  ✓ NTriples - 100 statements: ${duration.toFixed(2)}ms`)
    })
    ...
    it('should serialize 1,000 statements quickly', () => {
      ...
      console.log(`  ✓ NTriples - 1,000 statements: ${duration.toFixed(2)}ms`)
    })
    ...
    it('should serialize 10,000 statements efficiently', () => {
      ...
      console.log(`  ✓ NTriples - 10,000 statements: ${duration.toFixed(2)}ms`)
    })
    ...
    it('should handle large literals efficiently', () => {
      ...
      console.log(`  ✓ NTriples - 1,000 statements with large literals: ${duration.toFixed(2)}ms`)
    })
    ...
    it('should handle blank nodes efficiently', () => {
      ...
      expect(result).to.be.a('string')
      expect(duration).to.be.below(500)
      console.log(`  ✓ NTriples - 1,000 statements with blank nodes: ${duration.toFixed(2)}ms`)
    })
  ...
  describe('statementsToXML performance', () => {
    ...
    it('should serialize 10,000 statements in reasonable time', () => {
      ...
      console.log(`  ✓ XML - 10,000 statements: ${duration.toFixed(2)}ms`)
    })
    ...
    it('should handle large literals efficiently', () => {
      ...
      expect(result).to.be.a('string')
      expect(duration).to.be.below(1000)
      console.log(`  ✓ XML - 1,000 statements with large literals: ${duration.toFixed(2)}ms`)
    })
    ...
    it('should handle prefixes efficiently', () => {
      ...
      expect(result).to.be.a('string')
      expect(duration).to.be.below(1000)
      console.log(`  ✓ XML - 1,000 statements with prefixes: ${duration.toFixed(2)}ms`)
    })
    ...
    it('should handle blank nodes efficiently', () => {
      ...
      expect(result).to.be.a('string')
      expect(duration).to.be.below(1000)
      console.log(`  ✓ XML - 1,000 statements with blank nodes: ${duration.toFixed(2)}ms`)
    })
    ...
    it('should handle rdf:type efficiently', () => {
      ...
      expect(result).to.be.a('string')
      expect(duration).to.be.below(1000)
      console.log(`  ✓ XML - 1,000 statements with types: ${duration.toFixed(2)}ms`)
    })
    ...
    it('should handle many prefixes efficiently', () => {
      ...
      expect(result).to.be.a('string')
      expect(duration).to.be.below(2000)
      console.log(`  ✓ XML - 1,000 statements with 100 prefixes: ${duration.toFixed(2)}ms`)
    })
  })
})
